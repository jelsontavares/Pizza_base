...
c('.pizzaInfo--addButton').addEventListener('click', () => { 
    ...
    let identifier = pizzaJson[modalKey].id + 'X' + size;
...
function updateCart() {
    ...
    if (cart.length > 0) {
        ...
        c('.desconto span:last-child').innerHTML = `€ ${descount.toFixed(2)}`;
